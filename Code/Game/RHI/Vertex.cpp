...
void SetInputLayout(eVertexType vertType, D3D11_INPUT_ELEMENT_DESC*& layout, UINT& numElements) {
	...
	case VERTEX_TYPE_PCTTBN: {
		...
		layout[4] = { "BINORMAL",	0, DXGI_FORMAT_R32G32B32A32_FLOAT,	0, 48,	D3D11_INPUT_PER_VERTEX_DATA, 0 };
		layout[5] = { "NORMAL",		0, DXGI_FORMAT_R32G32B32A32_FLOAT,	0, 60,	D3D11_INPUT_PER_VERTEX_DATA, 0 };
		numElements = 6;
		break;
	}
	case VERTEX_TYPE_PCTTBNBN: {
